...
describe('getEmigration', () => {
  ...
  test('should return emigration', async () => {
    ...
    const databaseDtos = [{
      ...
      '[EDAD GRUPOS QUINQUENALES]': '[EDAD GRUPOS QUINQUENALES].[50 a 54 años]',
      '[PAÍS DE ORIGEN\/DESTINO]': '[PAÍS DE ORIGEN\/DESTINO].[América del Norte]',
      '[TIEMPO]': '[TIEMPO].[2008]',
      '[Measures].[Movimientos migratorios (La Rioja)]': 1.0
    }, {
      '[SEXO]': '[SEXO].[Ambos sexos]',
      '[EDAD GRUPOS QUINQUENALES]': '[EDAD GRUPOS QUINQUENALES].[Total]',
      '[PAÍS DE ORIGEN\/DESTINO]': '[PAÍS DE ORIGEN\/DESTINO].[Centro América y Caribe]',
      '[TIEMPO]': '[TIEMPO].[2008]',
