...
describe('getCarRegistrations', () => {
  ...
  test.skip('should get car registrations formatted', async () => {
    ...
    const mockData = [
      {
        '[Measures].[Var (%) anual], [NUEVO / USADO].[Todos los vehículos]':
          -2.27576974564926,
        '[Measures].[Var (%) mensual], [NUEVO / USADO].[Vehículo nuevo]': null,
        '[Measures].[Var (%) anual], [NUEVO / USADO].[Vehículo usado]': 21.0526315789474,
        '[Measures].[Var (%) en lo que va de año], [NUEVO / USADO].[Vehículo nuevo]':
          -19.7251114413076,
        '[Measures].[Var (%) en lo que va de año], [NUEVO / USADO].[Vehículo usado]':
          -25.8495145631068,
        '[Measures].[Var (%) mensual], [NUEVO / USADO].[Vehículo usado]': null,
        '[Measures].[Var (%) mensual], [NUEVO / USADO].[Todos los vehículos]':
          null,
        ...
        '[Measures].[Var (%) anual], [NUEVO / USADO].[Vehículo nuevo]':
          -4.20289855072464,
        '[Measures].[Var (%) en lo que va de año], [NUEVO / USADO].[Todos los vehículos]':
          -20.2921348314607,
