...
describe('parenting-age', () => {
  ...
  test('should return parenting age by gender and age', async () => {
    ...
    const mockData = [{
      ...
      '[MUNICIPIO]': '[MUNICIPIO].[Agoncillo]',
      '[GRUPOS DE EDAD PADRE]': '[GRUPOS DE EDAD PADRE].[de 50 a 54 años]',
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 10 a 14 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 15 a 19 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 20 a 24 años]': 2.0,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 25 a 29 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 30 a 34 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 35 a 39 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 40 a 44 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 45 a 49 años]': null,
      ...
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 10 a 14 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 15 a 19 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 20 a 24 años]': null,
      '[Measures].[Nacimientos], [GRUPOS DE EDAD MADRE].[de 25 a 29 años]': null,
